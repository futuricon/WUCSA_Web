...
namespace WUCSA.Web.Pages
{
    public class HistoryModel : PageModel
    {
        ...
        public HistoryModel(IBlogRepository blogRepository)
        {
        ...
        public async Task<IActionResult> OnGet()
        {
            ...
            var blog = await _blogRepository.GetListAsync<Core.Entities.BlogModel.Blog>(i => i.IsDeleted == true && i.StaticPage == Core.Entities.BlogModel.StaticPage.History);
            if (blog != null)
            {
